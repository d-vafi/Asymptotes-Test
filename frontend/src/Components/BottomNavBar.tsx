      ...
      <div id="bottomNavBar">
        ...
        {openMapMenu && (
          <div id='menu-map' className='flex flex-col justify-center items-center w-full  '>
            <li id='sgw-campus-option' className='flex justify-center w-full p-2 hover:bg-[#0096d7]' onClick={() => handleCampusNavigation('SGW')}>
              <a  className='w-full text-black hover:text-white'>
                SGW Campus
              </a>
            </li>
            <li id='loyola-campus-option' className='flex justify-center w-full p-2 hover:bg-[#0096d7]' onClick={() => handleCampusNavigation('LOY')}>
              <a  className='w-full text-black hover:text-white'>
                Loyola Campus
              </a>
            </li>
